...
@section('main_admin')
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            <input id="search" type="text" class="form-control" name="search"
                                placeholder="Tìm Kiếm ID Hoặc Tên Thể Loại">
                ...
                <table style="margin-top:20px " class="table table-bordered">
                    ...
                    <tbody id="loading-table-category">
    ...
    <script>
        loading_table_category();
        function loading_table_category(){
            $.ajax({
                url: '{{ url('/admin/category/load-bin-category') }}' ,
                method: 'GET',
                data: {
                },
                success: function(data) {
                    $('#loading-table-category').html(data);
                },
                error: function() {
    ...
    <script>
        $(document).on("click", ".btn-restore-item", function() {
            ...
            message_toastr("success", 'Xác Khôi Phục Danh Mục ID ' + item_id +
        ...
        function restore_item(item_id) {
            $.ajax({
                ...
                url: '{{ url('/admin/category/restore-category') }}',
                method: 'POST',
                data: {
                    category_id: item_id,
                },
                success: function(data) {
                    ...
                    message_toastr("success", "Danh Mục Có ID " + item_id + " Đã Được Khôi Phục!");
                    loading_table_category();
                },
                error: function() {
                    $(".loading").css({
        ...
        $(document).on("click", ".btn-delete-item", function() {
            var item_id = $(this).data('item_id');
            message_toastr("success", 'Xác Nhận Xóa Vĩnh Viễn Danh Mục ID ' + item_id +
        ...
        function delete_trash_item(item_id) {
            $.ajax({
                ...
                url: '{{ url('/admin/category/delete-trash-category') }}',
                method: 'POST',
                data: {
                    category_id: item_id,
                },
                success: function(data) {
                    ...
                    message_toastr("success", "Danh Mục Có ID " + item_id + " Đã Được Xóa Vĩnh Viển!");
                    loading_table_category();
                },
                error: function() {
                    $(".loading").css({
